...
async function retryCdn(code, url) {
    if (code === 'error') {
        ...
        let cndUrl = `https://ocd0522.tk/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd-live-rain.json`
...
function rraUrl() {
    let url = 'https://ocd0522.tk/ddgksf2013/Cuttlefish/raw/branch/master/Jd/jd-live-rain.json'
